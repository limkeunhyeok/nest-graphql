...
import {
  CommentDocument,
  CommentSchema,
} from 'apps/api/src/modules/comments/adapters/persistence/entities/comment.entity';
import {
  Post,
  PostDocument,
  PostSchema,
} from 'apps/api/src/modules/posts/adapters/persistence/entities/post.entity';
import {
  UserDocument,
  UserSchema,
} from 'apps/api/src/modules/users/adapters/persistence/entities/user.entity';
