...
import { expectUpdateManyResultResponseSucceed } from '../../expectations/common';
...
import {
  generateUpdateNotificationsInput,
  UPDATE_NOTIFICATIONS_OPERATION,
...
describe('Notification resolver (e2e)', () => {
  ...
  describe('Update notifications', () => {
    it('success', async () => {
      ...
      const params = {
        operationType: UPDATE_NOTIFICATIONS_OPERATION,
        query: UPDATE_NOTIFICATIONS_QUERY,
        variables: generateUpdateNotificationsInput(
      ...
      const data = getResponseData(res, UPDATE_NOTIFICATIONS_OPERATION);

      // then
      expectUpdateManyResultResponseSucceed(data);
    });
