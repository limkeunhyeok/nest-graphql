...
import {
  DELETE_NOTIFICATION_OPERATION,
  DELETE_NOTIFICATION_QUERY,
  generateDeleteNotificationInput,
...
describe('Notification resolver (e2e)', () => {
  ...
  describe('Delete notification', () => {
    it('success', async () => {
      ...
      const params = {
        operationType: DELETE_NOTIFICATION_OPERATION,
        query: DELETE_NOTIFICATION_QUERY,
        variables: generateDeleteNotificationInput(notification._id),
      };
      ...
      const data = getResponseData(res, DELETE_NOTIFICATION_OPERATION);
